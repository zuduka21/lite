    ...
    <article class="articlesItem articles__item">
        <a href="<?php echo $a->url ?>" class="articlesItem__link" title="<?php echo $a->name ?>">
            <div class="articlesItem__wrapperImg">
                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACwAAAAAAQABAAACAkQBADs=" data-src="<?php echo $a->cover_s ?>" alt="<?php echo $a->name ?>" class="articlesItem__img lazyload">
            </div>
