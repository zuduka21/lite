ArticleEditor.add('plugin', 'style', {
    ...
    popup: function(params, button) {
        ...
        var name = instance.hasClass(classes);

        // items
        var items = this._buildItems(this.opts.styles[type], name);
    ...
    _buildItems: function(styles, name) {
        var items = {};
        for (var key in styles) {
            items[key] = {
                ...
                active: (styles[key].classname === name)
            }
        }
