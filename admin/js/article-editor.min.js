...
ArticleEditor.add('module', 'editor', {
    ...
    _loaded: function() {
        ...
        // document ready
        this.getDocNode().addEventListener('DOMContentLoaded', function() {
...
ArticleEditor.add('class', 'popup.stack', {
    ...
    _renderItems: function() {
        ...
        for (var name in this.items) {
            if (this.items[name].hasOwnProperty('observer') && this.items[name].observer !== false) {
